...
const translations = {
  ...
  "schedule.suggest": { fr: "Suggérer", nl: "Voorstellen" },
  "schedule.suggestTitle": { fr: "Suggestions intelligentes", nl: "Slimme suggesties" },
  "schedule.suggestDesc": { fr: "Pré-remplit uniquement les cases vides à partir de l'historique. Aucune saisie existante n'est écrasée.", nl: "Vult enkel lege cellen op basis van de geschiedenis. Bestaande invoer wordt nooit overschreven." },
  "schedule.suggestApply": { fr: "Appliquer les suggestions", nl: "Suggesties toepassen" },
  "schedule.suggestEmpty": { fr: "Aucune suggestion disponible — soit toutes les cases sont déjà remplies, soit l'historique est vide.", nl: "Geen suggesties beschikbaar — alle cellen zijn al ingevuld of er is geen geschiedenis." },
  "schedule.suggestSelected": { fr: "sélectionnées", nl: "geselecteerd" },
  "schedule.suggestApplied": { fr: "Suggestions appliquées — vérifiez puis sauvegardez", nl: "Suggesties toegepast — controleer en sla op" },
  "schedule.suggestNoData": { fr: "Aucun historique trouvé pour générer des suggestions", nl: "Geen geschiedenis gevonden voor suggesties" },
  "schedule.source": { fr: "Source", nl: "Bron" },
  "schedule.source.prevWeek": { fr: "Sem. -1", nl: "Week -1" },
  "schedule.source.prev2Weeks": { fr: "Sem. -2", nl: "Week -2" },
  "schedule.source.template": { fr: "Sem. type", nl: "Modelweek" },
  "schedule.source.lastYear": { fr: "N-1", nl: "Vorig jaar" },
  "schedule.outOfRange": { fr: "hors plage magasin", nl: "buiten winkeluren" },
