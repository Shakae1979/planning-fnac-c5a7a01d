...
const translations = {
  ...
  "hours.detailTitle": { fr: "Détail des heures", nl: "Detail van de uren" },
  "hours.detailMonth": { fr: "Mois en cours", nl: "Lopende maand" },
  "hours.detailWeek": { fr: "Semaine sélectionnée", nl: "Geselecteerde week" },
  "hours.detailAbsences": { fr: "Absences du mois", nl: "Afwezigheden van de maand" },
  "hours.detailNoAbsence": { fr: "Aucune absence sur la période", nl: "Geen afwezigheid in deze periode" },
  "hours.detailDay": { fr: "Jour", nl: "Dag" },
  "hours.detailShift": { fr: "Horaire", nl: "Uurrooster" },
  "hours.detailNet": { fr: "Net", nl: "Netto" },
  "hours.detailStatus": { fr: "Statut", nl: "Status" },
  "hours.detailType": { fr: "Type", nl: "Type" },
  "hours.detailDays": { fr: "Jours", nl: "Dagen" },
  "hours.detailRest": { fr: "Repos", nl: "Rust" },
  ...
  // ========== Roles ==========
  "role.responsable": { fr: "Responsable", nl: "Kader" },
  "role.responsable.short": { fr: "Resp.", nl: "Kader" },
  "role.responsable.plural": { fr: "Responsables", nl: "Kader" },
  "role.tresorerie": { fr: "Trésorerie", nl: "Kas" },
  "role.tresorerie.short": { fr: "Trésor.", nl: "Kas" },
  "role.pt_bas": { fr: "PT bas", nl: "TP beneden" },
  "role.pt_bas.short": { fr: "PT bas", nl: "TP ben." },
  "role.pt_haut": { fr: "PT haut", nl: "TP boven" },
  "role.pt_haut.short": { fr: "PT haut", nl: "TP bov." },
  "role.pe_bas": { fr: "PE bas", nl: "EP beneden" },
  "role.pe_bas.short": { fr: "PE bas", nl: "EP ben." },
  "role.pe_haut": { fr: "PE haut", nl: "EP boven" },
  "role.pe_haut.short": { fr: "PE haut", nl: "EP bov." },
  "role.technique": { fr: "Technique", nl: "TP" },
  "role.technique.short": { fr: "Tech.", nl: "TP" },
  "role.technique.plural": { fr: "Techniques", nl: "TP" },
  "role.editorial": { fr: "Éditorial", nl: "EP" },
  "role.editorial.short": { fr: "Édit.", nl: "EP" },
  "role.editorial.plural": { fr: "Éditoriaux", nl: "EP" },
  ...
  "login.forgot": { fr: "Mot de passe oublié ?", nl: "Wachtwoord vergeten?" },
  "login.forgotTitle": { fr: "Réinitialiser le mot de passe", nl: "Wachtwoord opnieuw instellen" },
  "login.forgotDesc": { fr: "Saisissez votre email, vous recevrez un lien pour choisir un nouveau mot de passe.", nl: "Voer uw e-mailadres in, u ontvangt een link om een nieuw wachtwoord te kiezen." },
  "login.forgotSend": { fr: "Envoyer le lien", nl: "Link versturen" },
  "login.forgotSent": { fr: "Si un compte existe, un email a été envoyé.", nl: "Als er een account bestaat, is er een e-mail verzonden." },
  "reset.title": { fr: "Nouveau mot de passe", nl: "Nieuw wachtwoord" },
  "reset.newPassword": { fr: "Nouveau mot de passe", nl: "Nieuw wachtwoord" },
  "reset.confirmPassword": { fr: "Confirmer le mot de passe", nl: "Wachtwoord bevestigen" },
  "reset.submit": { fr: "Mettre à jour", nl: "Bijwerken" },
  ...
  "schedule.reset": { fr: "Réinitialiser", nl: "Resetten" },
  "schedule.resetConfirmTitle": { fr: "Réinitialiser la semaine ?", nl: "Week resetten?" },
  "schedule.resetConfirmDesc": { fr: "Cela effacera tous les horaires de la semaine affichée pour ce magasin. Cette action est irréversible.", nl: "Dit wist alle roosters van de getoonde week voor deze winkel. Deze actie is onomkeerbaar." },
  "schedule.resetSuccess": { fr: "Semaine réinitialisée", nl: "Week gereset" },
  "schedule.notifyTeam": { fr: "Notifier l'équipe", nl: "Team verwittigen" },
  "schedule.notifyTeamHint": { fr: "Enregistrez d'abord vos modifications", nl: "Sla eerst je wijzigingen op" },
  "schedule.notifyNone": { fr: "Aucun changement à notifier", nl: "Geen wijzigingen om te melden" },
  ...
  "team.existingAccount": { fr: "Compte existant", nl: "Bestaand account" },
  "team.linkToStore": { fr: "Rattacher à ce magasin", nl: "Koppelen aan deze winkel" },
  "team.unlinkStore": { fr: "Détacher du magasin", nl: "Loskoppelen van winkel" },
  "team.accountLinked": { fr: "Compte rattaché à ce magasin", nl: "Account gekoppeld aan deze winkel" },
  "team.accountUnlinked": { fr: "Compte détaché du magasin", nl: "Account losgekoppeld van winkel" },
  "team.unlinkConfirm": { fr: "Détacher ce compte de ce magasin ? Le compte reste actif sur ses autres magasins.", nl: "Dit account loskoppelen van deze winkel? Het account blijft actief in de andere winkels." },
  "team.storeManagerHere": { fr: "Responsable de ce magasin", nl: "Verantwoordelijke van deze winkel" },
  "team.managerUpdated": { fr: "Responsable mis à jour", nl: "Verantwoordelijke bijgewerkt" },
