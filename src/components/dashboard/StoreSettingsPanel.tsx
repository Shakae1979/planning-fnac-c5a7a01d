  ...
  return (
    <div>
      ...
      <div className="max-w-md rounded-lg border bg-card p-6 space-y-6">
        <div>
          <h3 className="text-sm font-semibold mb-1">{t("settings.timeRangeTitle")}</h3>
          <p className="text-xs text-muted-foreground mb-4">
            {t("settings.timeRangeDesc")} <strong>{currentStore.name}</strong>.
          </p>
          <div className="flex items-center gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-muted-foreground">{t("settings.start")}</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-muted-foreground">{t("settings.end")}</label>
